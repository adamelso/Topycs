...
namespace spec\Topycs\Discussions\Repository\Doctrine\ORM;
...
class ThreadRepositorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Topycs\Discussions\Repository\Doctrine\ORM\ThreadRepository');
    }
    ...
    function it_finds_by_category(
        ...
        $result->shouldBeAnInstanceOf('Topycs\Discussions\Entity\Collection\ThreadCollection');
    }
